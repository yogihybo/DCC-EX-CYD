...
| **ESP32-32E 3.5" LCD** | `ESP32-32E-3_5in-LCD` | 3.5" ST7796 | 320×480 | XPT2046 (shared LCD SPI bus) | 8 (2×4) |
...
2. Select the environment for your board:
   ...
   - `ESP32-32E-3_5in-LCD` for the 3.5" LCD board.
